...
using CSharp_lab2_Shcherbatiuk.Models;
using CSharp_lab2_Shcherbatiuk.Tools;
using CSharp_lab2_Shcherbatiuk.Tools.Managers;

namespace CSharp_lab2_Shcherbatiuk.ViewModels
{
